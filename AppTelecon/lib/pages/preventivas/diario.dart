...
class _CadastroOCState extends State<Diario> {
  ...
  final List<String> _atividade = [
    'APLICAÇÃO DE MANTAS',
    'CÉLULA',
    'MISSÃO GERÊNCIA',
    'BACKBONE',
    'MISSÃO COM OUTRO GESTOR'
  ];
  ...
  Future<void> _enviarFormulario() async {
    ...
    final url = Uri.parse(
        'https://sistema32.cloud/move/Api/ocorrencias/ocorrencia.php');
    ...
    request.fields['atividade'] = _atividadez!;
            ...
            child: ListView(
              children: [
                ...
                DropdownButtonFormField<String>(
                  value: _atividadez,
                  decoration:
                      const InputDecoration(labelText: 'Atividade de Hoje'),
                  items: _atividade.map((String value) {
                    return DropdownMenuItem<String>(
                      value: value,
                      child: Text(value),
                    );
                  ...
                  onChanged: (String? newValue) {
                    setState(() {
                      _atividadez = newValue;
                    });
                  },
                  validator: (value) {
                    if (value == null) {
                      return 'Por favor, selecione sua atividade hoje';
                    }
                    return null;
                  },
                ),
