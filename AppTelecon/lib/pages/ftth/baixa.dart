...
class _baixaPageState extends State<baixa> {
  ...
  List<String> _materiais = []; // Lista de materiais carregados da API
  ...
  onPressed: () async {
    ...
    if (!conexaoInternet) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('Sem conexão com a internet. Verifique sua conexão e tente novamente.'),
        ),
      );
      return;
    }
  ...
  style: ElevatedButton.styleFrom(
    primary: Color.fromRGBO(13, 71, 161, 1),
                ...
                ElevatedButton(
                  ...
                  child: Text('+ Adicionar Material',style: TextStyle(
                        color: Colors.black,
                      ),),
                ),
              ],
