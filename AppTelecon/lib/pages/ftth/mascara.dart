...
class _MascaraDeEncerramentoPageState extends State<MascaraDeEncerramentoPage> {
  ...
  final List<String> _caboo = ['12','36','72','144','288', 'PRECON - 1', 'NÃO SE APLICA'];
  ...
  showDialog(
    ...
    builder: (context) {
      return AlertDialog(
        ...
        content: Text('Por favor, selecione o campo acima.'),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(context),
            child: Text('OK'),
  ...
  Future<void> _submitForm() async {
    if (_validateForm()) {
      String apiUrl =
          // 'https://sistema32.cloud/move/Api/VPS/mascara.php?ba=${widget.ba}'; 
          'https://sistema32.cloud/move/Api/VPS/nova_mascara.php?ba=${widget.ba}';// Substitua pelo URL do seu arquivo PHP
      ...
      try {
        ...
        request.fields['capacidade_cabo'] = _cabo!;
        ...
        throw Exception('Erro ao enviar os dados: $e $_cabo');
      }
