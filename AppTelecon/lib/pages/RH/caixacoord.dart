...
import 'dart:convert';
import 'package:moove/pages/RH/analisecoord.dart';

class caixacoord extends StatefulWidget {
  final String loggedInUser;
  

  const caixacoord({Key? key, required this.loggedInUser});

  @override
  State<caixacoord> createState() => _CaixaState();
}

class _CaixaState extends State<caixacoord> {
