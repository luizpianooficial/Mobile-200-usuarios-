...
class _IdentidadeBaFormState extends State<IdentidadeBaFormhc> {
  ...
  Future<void> carregarBaData() async {
    var url = Uri.parse(
        'https://sistema32.cloud/move/Api/HC/puxacaixa.php?sa=${widget.sa}');
  ...
  Future<void> salvarObservacaoTecnico() async {
    ...
    var url = Uri.parse('https://sistema32.cloud/move/Api/HC/updatehc.php');
  ...
  Future<void> enviarDadosViaAPI(String obsTec, String idUsu) async {
    ...
    var url = Uri.parse('https://sistema32.cloud/move/Api/HC/logs.php');
  ...
  Future<void> sendImagesToServer() async {
    String url = 'https://sistema32.cloud/move/Api/HC/id_usu.php';
